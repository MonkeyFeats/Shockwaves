...
void onInit(CRules@ this)
{
	...
	driver.AddShader("shockwave", 2.0f);
...
void onTick(CRules@ this)
{
	...
	if (getRules().get_s32("timer")+15 > getGameTime())
	{
		getDriver().SetShaderFloat("shockwave", "time", (getGameTime() - getRules().get_s32("timer"))*0.02);
	}
	else
	{
		getDriver().SetShaderFloat("shockwave", "time", 10); //shitty way to turn the shockwave off
	}
}
